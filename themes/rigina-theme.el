...
(custom-theme-set-faces
 ...
 '(popup-scroll-bar-background-face ((t (:background "#0f0f0f"))))
 '(eval-sexp-fu-flash ((t (:background "#0f0f0f" :foreground "white"))))
 '(nrepl-eval-sexp-fu-flash ((t (:background "#0f0f0f" :foreground "white"))))
 ...
 '(magit-section-title ((t (:foreground "#dfafdf" :background "#0f0f0f"))))
 ...
 '(erb-face ((t (:foreground "#cccccc" :background "#0f0f0f"))))
 '(erb-exec-face ((t (:inherit erb-face))))
 '(erb-out-face ((t (:inherit erb-face))))
 '(erb-delim-face ((t (:inherit erb-face :foreground "#efbfef" :background "#0f0f0f"))))
 '(erb-exec-delim-face ((t (:inherit erb-delim-face))))
 '(erb-out-delim-face ((t (:inherit erb-delim-face :foreground "#efbfef" :background "#0f0f0f"))))
 '(erb-comment-face ((t (:inherit erb-face :foreground "#755273" :background "#0f0f0f"))))
 '(erb-comment-delim-face ((t (:inherit erb-face :foreground "#555" :background "#0f0f0f"))))
 ...
 '(erc-notice-face ((t (:foreground "#a883a3" :background "#0f0f0f"))))
 '(erc-pal-face ((t (:foreground "#efbfef" :weight bold))))
 '(erc-prompt-face ((t (:foreground "#d1afdd" :background "#0f0f0f" :weight bold))))
 ...
 '(w3m-header-line-location-title ((t (:foreground "#efefef" :underline t :weight bold))))
 '(w3m-history-current-url ((t (:inherit match))))
 '(w3m-lnum ((t (:foreground "#787878"))))
 '(w3m-lnum-match ((t (:background "#a582a3" :foreground "#0f0f0f"))))
